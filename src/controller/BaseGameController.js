...
export default class BaseGameController {
    ...
    protected BackgroundWorkManager backgroundWorkManager;
    protected BaseGameView baseGameView;
    protected RucksackService rucksackService;
    protected JournalEntryService journalEntryService;
    protected TrayIcon trayIcon;

    public static final int ORIGINAL_RUCKSACK_X = 700;
    public static final int ORIGINAL_RUCKSACK_Y = 500;

    public static final int ORIGINAL_RUCKSACK_CLOSE_X = 700;
    public static final int ORIGINAL_RUCKSACK_CLOSE_Y = 10;

    public static final int MENU_Z_ORDER = 10000;

    public static final int RUCKSACK_MENU_ITEM_COUNT = 9;

    public static final int ORIGINAL_BUILD_MENU_X = 600;
    public static final int ORIGINAL_BUILD_MENU_Y = 500;

    public static final int ORIGINAL_BUILD_MENU_CLOSE_X = 700;
    public static final int ORIGINAL_BUILD_MENU_CLOSE_Y = 10;

    public static final int ORIGINAL_JOURNAL_X = 500;
    public static final int ORIGINAL_JOURNAL_Y = 500;

    public static final int ORIGINAL_JOURNAL_CLOSE_X = 700;
    public static final int ORIGINAL_JOURNAL_CLOSE_Y = 10;
